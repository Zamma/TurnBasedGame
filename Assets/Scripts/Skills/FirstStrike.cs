...
namespace AssemblyCSharp
{
		...
		{
		BattleEvent battle;
				public FirstStrike (GameState state,GameObject gameObject) : base (state,gameObject)
				{
					activates.Add("attackedInitial");
					//battle = state.getBattle(); //TODO impliment this
				}

				public void activate(string activator){ //this may interfere with other skills if it is called in the wrong order.
